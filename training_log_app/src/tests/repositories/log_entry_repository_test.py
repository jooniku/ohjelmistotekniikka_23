...
class TestLogEntryRepository(unittest.TestCase):
    ...
    def test_created_entry_is_saved_correctly(self):
        ...
        from_database = self.repo.get_users_log_entry_by_id(user=self.user, log_id=1)
        ...
        self.assertEqual(from_database[7], self.first_entry.what_did_not_go_well)
        self.assertEqual(from_database[8], self.first_entry.goal_for_next_session)
        self.assertEqual(from_database[9], self.first_entry.was_last_goal_achieved)
    ...
    def test_get_users_session_styles_ranked_finds_number_one(self):
        ...
        most_common_style = self.repo.get_users_session_styles_ranked(self.user)[0][1]
    ...
    def test_get_users_session_styles_ranked_finds_number_two(self):
        ...
        second_most_common = self.repo.get_users_session_styles_ranked(self.user)[1][1]
